          ...
          <div class="row my-2">
              <div class="col">
                  ...
                  <nav class="navbar navbar-light bg-light my-2">
                      <div class="container-fluid">
                        <a class="navbar-brand mx-auto" href="#">Team profile Generator</a>
                      </div>
                    </nav>
...
class GenHTML {
    ...
    constructor(managerArr = [], engineersArr = [], internsArr = []) {
        this.manager = managerArr;
        this.engineers = engineersArr;
        this.interns = internsArr;
    ...
    createManagerCard() {
        managerName = this.manager[0].name
        managerOffice = this.manager[0].officeNumber
        managerEmail = this.manager[0].email
        var ManagerCard = `
        ...
        <div class="col-md-4 mx-auto">
                        <div class="card mx-auto" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-4 profile-card js-profile-card">
        
                                    <div class=profile-card__name>  </div>
        
                                    <div class="profile-card__cnt js-profile-cnt">
                                        <div class="profile-card__name"><strong>Manager</strong></div>
                                        <div class="profile-card__txt"><strong>${managerName}</strong></div>
                                        <div class="profile-card__txt"><strong>${managerOffice}</strong></div>
                                        <div class="profile-card-loc">
        
                                        </div>
        
                                        <div class="profile-card-ctr">
                                            <button class="profile-card__button button--blue"><a class="contactmeIcon" href="mailto:${managerEmail}" >${managerEmail}</button>
    ...
    createEngineerCard() {
        ...
        for (var i=0; i < this.engineers.length;i++) {
            EngineerName = this.engineers[i].name
            EngineerEmail = this.engineers[i].email
            EngineerGitHub = this.engineers[i].gitHub
            var EngineerCard = `
                  ...
                  <div class="card mx-auto" style="width: 18rem;">
                      ...
                      <div class="card-body">
                          ...
                          <div class="col-md-4 profile-card js-profile-card">
                              ...
                              <div class="profile-card__cnt js-profile-cnt">
                                  <div class="profile-card__name">Engineer</div>
                                  <div class="profile-card__txt"><strong>${EngineerName}</strong>
                                  </div>
                                  ...
                                  <div class="profile-card-ctr">
                                      <button class="profile-card__button button--blue"><a class="contactmeIcon" href="mailto:${EngineerEmail}" >${EngineerEmail}</button>
  
                                  </div>
  
                                  <a href="https://github.com/${EngineerGitHub}" class="profile-card-social__item github" target="_blank">
  ...
  `
            var  engCard
            if(EngineerCard != "undefined"){
            engCard = engCard + EngineerCard
            }
        }
       return engCard
    }
    ...
    createInternCard() {
        ...
        for(var i=0; i < this.interns.length; i++ ) {
            InternName = this.interns[i].name
            InternEmail = this.interns[i].email
            InternSchool = this.interns[i].school
            var InternCard = `
                            ...
                            <div class="card mx-auto" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-4 profile-card js-profile-card">
                                        ...
                                        <div class=profile-card__name>  </div>
                                        <div class="profile-card__cnt js-profile-cnt">
                                            <div class=profile-card__name> Intern </div>
                                            <div class="profile-card__txt"><strong>${InternName}</strong></div>
                                            <div class="profile-card__txt"><strong>${InternSchool}</strong>
                                            </div>
                                            <div class="profile-card-loc">
                                            ...
                                            <div class="profile-card-ctr">
                                                <button class="profile-card__button button--blue"><a class="contactmeIcon" href="mailto:${InternSchool}" >${InternSchool}</button>
            ...
            var  intCard
            if(InternCard != "undefined"){
                intCard = intCard + InternCard
            }
    ...
    genHTMLPage() {
        ...
        var page = HTMLTop + this.createManagerCard() + (this.createEngineerCard()).replace("undefined","") + (this.createInternCard()).replace("undefined","") + HTMLBottom
